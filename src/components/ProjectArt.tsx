        ...
        <div className="visual-dashboard">
          ...
          {isPipeline ? (
            ...
            <div className="visual-body">
              ...
              <div className="visual-service-grid"><div className="service-main"><span>API RESPONSE / HEALTH</span><div className="service-wave"><i /><i /><i /><i /><i /><i /><i /><i /><i /><i /><i /><i /></div><strong>Operational <span>●</span></strong></div><div className="service-side"><span>ACCESS</span><strong>RBAC</strong><small>Protected endpoints</small><hr /><span>DELIVERY</span><strong>Docker</strong><small>Consistent environments</small></div></div>
